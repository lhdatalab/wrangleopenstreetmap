...
#lower_colon = re.compile(r'^addr:([a-z]|_)*:([a-z]|_)*$')
        ...
        if element.findall("tag"):
            for tag in element.iter("tag"):
                if not problemchars.search(tag.attrib["k"]):
                    ...
                    # Find attributes with ':' but do not start with 'addr:'
                    elif not re.match(r'(addr)', tag.attrib["k"]) and re.search(r':', tag.attrib["k"]):
                        newkey = re.sub(":", " ", tag.attrib["k"])
